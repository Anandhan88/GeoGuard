...
const navItems = [
  ...
  { label: 'Evacuation', icon: Navigation, path: '/app/map', section: 'response' },
  { label: 'Shelters', icon: Building, path: '/app/map', section: 'response' },
  { label: 'Resources', icon: Truck, path: '/app/authority', section: 'response' },
  { label: 'AI Assistant', icon: MessageSquare, path: '/app/citizen', section: 'tools' },
