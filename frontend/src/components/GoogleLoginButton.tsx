...
export const GoogleLoginButton = ({
  ...
  return (
    <button
      ...
      disabled={loading}
      className={`w-full py-3.5 px-4 rounded-xl bg-white hover:bg-slate-100 text-slate-900 font-semibold text-sm transition-all duration-200 flex items-center justify-center gap-3 shadow-lg shadow-white/5 active:scale-[0.99] disabled:opacity-75 ${className}`}
    >
      {loading ? (
